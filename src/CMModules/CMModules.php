<?php
/**
* A model for managing Wolf modules.
*
* @package WolfCore
*/
...
* Properties
*/
  private $wolfCoreModules = array('CWolf', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $wolfCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
...
*/
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isWolfCore'] = in_array($rc->name, $this->wolfCoreModules);
      $details['isWolfCMF'] = in_array($rc->name, $this->wolfCMFModules);
