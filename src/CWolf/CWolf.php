<?php
/**
* Main class for Wolf, holds everything.
*
* @package WolfCore
*/
class CWolf implements ISingleton {
        ...
        protected function __construct() {
                ...
                $wo = &$this;
    require(WOLF_SITE_PATH.'/config.php');
  ...
  /**
         ...
         * @return CWolf The instance of this class.
         */
        public static function Instance() {
                if(self::$instance == null) {
                        self::$instance = new CWolf();
                }
  ...
  public function ThemeEngineRender() {
    ...
    $themePath  = WOLF_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = WOLF_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    $wo = &$this;
    // First the default Wolf themes/functions.php
    include(WOLF_INSTALL_PATH . '/themes/functions.php');
