...
function get_gravatar($size=null) {
  return 'http://www.gravatar.com/avatar/' . md5(strtolower(trim(CWolf::Instance()->user['email']))) . '.jpg?r=pg&amp;d=wavatar&amp;' . ($size ? "s=$size" : null);
}
...
function create_url($urlOrController=null, $method=null, $arguments=null) {
  return CWolf::Instance()->CreateUrl($urlOrController, $method, $arguments);
}
